...
#line 2 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
...
#line 34 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
FLOAT fClosest  = 100000.0f;
#line 35 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
FLOAT fDistance ;
#line 37 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
m_penCurrentWatch  = NULL ;
#line 39 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
for(INDEX iPlayer  = 0;iPlayer  < GetMaxPlayers  ();iPlayer  ++){
#line 40 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
CEntity  * penPlayer  = GetPlayerEntity  (iPlayer );
#line 42 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
if(penPlayer  != NULL  && penPlayer  -> GetFlags  () & ENF_ALIVE  && ! (penPlayer  -> GetFlags  () & ENF_INVISIBLE )){
#line 43 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
fDistance  = 100000.0f;
#line 44 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
if(m_bRangeWatcher ){
#line 46 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
fDistance  = (penPlayer  -> GetPlacement  () . pl_PositionVector  - 
#line 47 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
GetPlacement  () . pl_PositionVector ) . Length  ();
#line 48 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
}else {
#line 49 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
if(m_penOwner  != NULL ){
#line 51 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
fDistance  = (penPlayer  -> GetPlacement  () . pl_PositionVector  - 
#line 52 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
m_penOwner  -> GetPlacement  () . pl_PositionVector ) . Length  ();
#line 53 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
}
#line 54 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
}
#line 55 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
if(fDistance  < fClosest ){
#line 56 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
fClosest  = fDistance ;
#line 57 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
m_penCurrentWatch  = penPlayer ;
#line 58 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
}
#line 59 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
}
#line 60 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
}
#line 62 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
return (fClosest  < m_fDistance );
#line 63 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
}
  
#line 66 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
void CWatchPlayers::SendCloseEvent(void) {
#line 68 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
if(m_bRangeWatcher  && m_penOwner  == NULL ){
#line 71 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
}else {
#line 72 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
SendToTarget  (m_penOwner  , m_eetEventClose  , m_penCurrentWatch );
#line 73 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
}
#line 74 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
}
  
#line 77 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
void CWatchPlayers::SendFarEvent(void) {
#line 79 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
if(m_bRangeWatcher  && m_penOwner  == NULL ){
#line 82 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
}else {
#line 83 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
if(m_penFar  != NULL ){
#line 84 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
SendToTarget  (m_penFar  , m_eetEventFar );
#line 85 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
}else {
#line 86 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
SendToTarget  (m_penOwner  , m_eetEventFar );
#line 87 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
}
#line 88 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
}
#line 89 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
}
BOOL CWatchPlayers::
...
#line 95 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
InitAsEditorModel  ();
#line 96 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
SetPhysicsFlags  (EPF_MODEL_IMMATERIAL );
#line 97 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
SetCollisionFlags  (ECF_IMMATERIAL );
#line 100 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
SetModel  (MODEL_WATCHPLAYERS );
#line 101 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
SetModelMainTexture  (TEXTURE_WATCHPLAYERS );
#line 103 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
if(m_fWaitTime  < 0.1f){
#line 104 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
m_fWaitTime  = 0.1f;
#line 105 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
}
#line 107 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
if(m_bActive ){
#line 108 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
Jump(STATE_CURRENT, STATE_CWatchPlayers_Active, TRUE, EVoid());return TRUE;
#line 109 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
}else {
#line 110 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
Jump(STATE_CURRENT, STATE_CWatchPlayers_Inactive, TRUE, EVoid());return TRUE;
#line 111 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
...
#line 116 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
...
;
#line 117 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
...
#line 122 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
...
#line 124 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
UnsetTimer();Jump(STATE_CURRENT,0x02be0005, FALSE, EInternal());return TRUE;
#line 125 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
}ASSERT(FALSE);break;default:{
#line 127 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
return TRUE;
#line 128 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
}ASSERT(FALSE);break;
#line 129 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
...
#line 130 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
...
#line 135 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
...
#line 136 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
...
#line 138 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
if(! IsAnyPlayerClose  ()){
#line 140 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
SendFarEvent  ();
#line 141 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
Jump(STATE_CURRENT, STATE_CWatchPlayers_FarWatch, TRUE, EVoid());return TRUE;
#line 142 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
}
#line 143 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
return TRUE;
#line 144 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
...
#line 146 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
...
#line 147 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
...
#line 152 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
...
#line 153 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
SetTimerAfter(m_fWaitTime );
...
#line 155 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
if(IsAnyPlayerClose  ()){
#line 157 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
SendCloseEvent  ();
#line 158 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
Jump(STATE_CURRENT, STATE_CWatchPlayers_CloseWatch, TRUE, EVoid());return TRUE;
#line 159 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
}
#line 160 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
return TRUE;
#line 161 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
}ASSERT(FALSE);break;case(EVENTCODE_ETimer):{const ETimer&e= (ETimer&)__eeInput;
UnsetTimer();Jump(STATE_CURRENT,0x02be000d, FALSE, EInternal());return TRUE;}ASSERT(FALSE);break;default: return FALSE; break;
#line 163 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
...
#line 164 "C:/MyMod/Sources/EntitiesMP/WatchPlayers.es"
